...
define('durandal/binder',["durandal/system","knockout"],function(e,n){function t(n){return void 0===n?{applyBindings:!0}:e.isBoolean(n)?{applyBindings:n}:(void 0===n.applyBindings&&(n.applyBindings=!0),n)}function i(i,c,w,l){if(!c||!w)return a.throwOnErrors?e.error(r):e.log(r,c,l),void 0;if(!c.getAttribute)return a.throwOnErrors?e.error(o):e.log(o,c,l),void 0;var d=c.getAttribute("data-view");try{var f;return i&&i.binding&&(f=i.binding(c)),f=t(f),a.binding(l,c,f),f.applyBindings?(e.log("Binding",d,l),n.applyBindings(w,c)):i&&n.utils.domData.set(c,u,{$data:i}),a.bindingComplete(l,c,f),i&&i.bindingComplete&&i.bindingComplete(c),n.utils.domData.set(c,s,f),f}catch(v){v.message=v.message+";\nView: "+d+";\nModuleId: "+e.getModuleId(l),a.throwOnErrors?e.error(v):e.log(v.message)}}var a,r="Insufficient Information to Bind",o="Unexpected View Type",s="durandal-binding-instruction",u="__ko_bindingContext__";return a={binding:e.noop,bindingComplete:e.noop,throwOnErrors:!1,getBindingInstruction:function(e){return n.utils.domData.get(e,s)},bindContext:function(e,n,t){return t&&e&&(e=e.createChildContext(t)),i(t,n,e,t||(e?e.$data:null))},bind:function(e,n){return i(e,n,e,e)}}});
...
requirejs.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions"}}),define("jquery",[],function(){return jQuery}),define("knockout",ko),define('main',["durandal/system","durandal/app","durandal/viewLocator"],function(n,e,t){n.debug(!0),e.title="Flash Cards",e.configurePlugins({router:!0,dialog:!0,widget:!0,observable:!0}),e.start().then(function(){t.useConvention(),e.setRoot("viewmodels/shell","entrance")})});
define('models/card',[],function(){return function(e,n,s,t){this.frontHeading=e,this.front=n,this.backHeading=s,this.back=t}});
define('mockData/durandal',["models/card"],function(e){var a=[new e("True or False:","Durandal is a data access framework for JavaScript.","False:","Durandal is Single-Page Application framework."),new e("True or False:","Durandal has writen its own module loader.","False:","Durandal uses RequireJS as it module loader.")];return{cards:a}});
...
define('services/flashCardService',["durandal/system","mockData/multiplication","mockData/statesAndCapitals","mockData/durandal","mockData/requirejs"],function(e,n,t,s,a){var i={Multiplication:n.cards,"States and Capitals":t.cards,Durandal:s.cards,RequireJS:a.cards},r=[];for(var w in i)i.hasOwnProperty(w)&&r.push(w);var o={};return o.catalogNames=function(){return e.log("******** Getting catalog names"),e.defer(function(e){e.resolve(r)})},o.getCards=function(n){return e.log("******** Getting cards"),e.defer(function(e){i[n]?e.resolve(i[n]):e.reject()})},o});
...
define('viewmodels/cards',["durandal/system","plugins/router","models/selectedCards"],function(e,n,t){function s(s){var a="#cards/"+encodeURIComponent(t.name)+"/id/"+s;e.log(a),n.navigate(a)}var a={},i="";return a.selected=t,a.router=n.createChildRouter().makeRelative({moduleId:"viewmodels",route:"cards/:param1"}).map([{route:["id(/:param2)",""],moduleId:"card",title:"Card",nav:!0}]).buildNavigationModel(),a.activate=function(n){e.log("******** activate for index"),i=n},a.binding=function(){return e.log("******** binding complete for index"),t.select(i)},a.previous=function(){t.hasPrevious&&s(t.previousIndex())},a.next=function(){t.hasNext&&s(t.nextIndex())},a});
